...
const LOOKUP_F64: [f64; TABLE_SIZE] =
  bb_macros::lookup_table!(min: 0.0, max: 1.57079632679, steps: 256, ty: f64);
const LOOKUP_F32: [f32; TABLE_SIZE] =
  bb_macros::lookup_table!(min: 0.0, max: 1.57079632679, steps: 256, ty: f32);
