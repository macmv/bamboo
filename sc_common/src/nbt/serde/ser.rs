...
impl<'a> ser::Serializer for &'a mut Serializer {
  ...
  fn serialize_u8(self, v: u8) -> Result<()> { self.serialize_i8(v.try_into()?) }
  fn serialize_u16(self, v: u16) -> Result<()> { self.serialize_i16(v.try_into()?) }
  fn serialize_u32(self, v: u32) -> Result<()> { self.serialize_i32(v.try_into()?) }
  fn serialize_u64(self, v: u64) -> Result<()> { self.serialize_i64(v.try_into()?) }
  ...
  fn serialize_seq(self, _len: Option<usize>) -> Result<Self::SerializeSeq> {
    Ok(SeqSerializer { ser: self, items: vec![] })
  }
...
impl<'a> ser::SerializeTuple for SeqSerializer<'a> {
  ...
  fn end(self) -> Result<()> { <Self as ser::SerializeSeq>::end(self) }
}
